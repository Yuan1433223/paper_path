...
用于把保存下来的pt文件进行Zero-shot
"""

"""
# bagua - 5000
# Terminal result - 20251128 [epoch=5 seed=42 self.train_max_samples=5000 self.val_max_samples=1000]:
...
# 公平对比基线
# Terminal result - 20251202 [epoch=5 seed=42 self.train_max_samples=50000 self.val_max_samples=5000]:
========== COCO Zero-Shot Results ==========
Image-to-Text Retrieval:
  R@1:  55.94%
  R@5:  79.36%
...
============================================
 SUCCESS: R@1 > 50%. Baseline verified.
Epoch 1/5: 100%|███████████████████| 1562/1562 [06:06<00:00,  4.26it/s, batch_loss=0.1473, avg_loss=0.1797]
Epoch 2/5: 100%|███████████████████| 1562/1562 [06:15<00:00,  4.16it/s, batch_loss=0.1684, avg_loss=0.1443]
Epoch 3/5: 100%|███████████████████| 1562/1562 [06:20<00:00,  4.10it/s, batch_loss=0.0683, avg_loss=0.1340]
Epoch 4/5: 100%|███████████████████| 1562/1562 [06:09<00:00,  4.23it/s, batch_loss=0.1563, avg_loss=0.1253]
Epoch 5/5: 100%|███████████████████| 1562/1562 [06:13<00:00,  4.18it/s, batch_loss=0.0514, avg_loss=0.1230]

# Terminal result - 20251202 [epoch=5 seed=43 self.train_max_samples=50000 self.val_max_samples=5000]:
========== COCO Zero-Shot Results ==========
Image-to-Text Retrieval:
  R@1:  56.88%
  R@5:  80.16%
...
============================================
 SUCCESS: R@1 > 50%. Baseline verified.
Epoch 1/5: 100%|███████████████████| 1562/1562 [06:08<00:00,  4.23it/s, batch_loss=0.0532, avg_loss=0.1835]
Epoch 2/5: 100%|███████████████████| 1562/1562 [06:07<00:00,  4.25it/s, batch_loss=0.2796, avg_loss=0.1450]
Epoch 3/5: 100%|███████████████████| 1562/1562 [06:24<00:00,  4.07it/s, batch_loss=0.0412, avg_loss=0.1332]
Epoch 4/5: 100%|███████████████████| 1562/1562 [06:33<00:00,  3.97it/s, batch_loss=0.1002, avg_loss=0.1275]
Epoch 5/5: 100%|███████████████████| 1562/1562 [06:29<00:00,  4.01it/s, batch_loss=0.2453, avg_loss=0.1222]

# Terminal result - 20251202 [epoch=5 seed=44 self.train_max_samples=50000 self.val_max_samples=5000]:
========== COCO Zero-Shot Results ==========
Image-to-Text Retrieval:
  R@1:  56.30%
  R@5:  80.72%
...
============================================
 SUCCESS: R@1 > 50%. Baseline verified.
Epoch 1/5: 100%|███████████████████| 1562/1562 [06:28<00:00,  4.02it/s, batch_loss=0.0665, avg_loss=0.1802]
Epoch 2/5: 100%|███████████████████| 1562/1562 [06:17<00:00,  4.13it/s, batch_loss=0.0701, avg_loss=0.1417]
Epoch 3/5: 100%|███████████████████| 1562/1562 [06:19<00:00,  4.12it/s, batch_loss=0.0902, avg_loss=0.1333]
Epoch 4/5: 100%|███████████████████| 1562/1562 [06:14<00:00,  4.17it/s, batch_loss=0.0721, avg_loss=0.1253]
Epoch 5/5: 100%|███████████████████| 1562/1562 [06:08<00:00,  4.24it/s, batch_loss=0.1731, avg_loss=0.1225]
...
============================================
 SUCCESS: R@1 > 50%. Baseline verified.
loss：
Epoch 1/10: 100%|███████████████████| 1562/1562 [22:30<00:00,  1.16it/s, batch_loss=0.2085, avg_loss=0.1967]
Epoch 2/10: 100%|███████████████████| 1562/1562 [07:02<00:00,  3.69it/s, batch_loss=0.1961, avg_loss=0.1440]
Epoch 3/10: 100%|███████████████████| 1562/1562 [06:58<00:00,  3.74it/s, batch_loss=0.0992, avg_loss=0.1245]
Epoch 4/10: 100%|███████████████████| 1562/1562 [07:02<00:00,  3.69it/s, batch_loss=0.2102, avg_loss=0.1124]
Epoch 5/10: 100%|███████████████████| 1562/1562 [07:11<00:00,  3.62it/s, batch_loss=0.0501, avg_loss=0.1034]
...
============================================
 SUCCESS: R@1 > 50%. Baseline verified.
loss:
Epoch 1/5: 100%|███████████████████| 1562/1562 [07:07<00:00,  3.65it/s, batch_loss=0.0691, avg_loss=0.1992]
Epoch 2/5: 100%|███████████████████| 1562/1562 [07:12<00:00,  3.61it/s, batch_loss=0.2872, avg_loss=0.1428]
Epoch 3/5: 100%|███████████████████| 1562/1562 [07:08<00:00,  3.65it/s, batch_loss=0.0508, avg_loss=0.1220]
Epoch 4/5: 100%|███████████████████| 1562/1562 [07:12<00:00,  3.61it/s, batch_loss=0.0922, avg_loss=0.1117]
Epoch 5/5: 100%|███████████████████| 1562/1562 [07:01<00:00,  3.71it/s, batch_loss=0.2187, avg_loss=0.1014]
...
============================================
loss:
Epoch 1/5: 100%|███████████████████| 1562/1562 [07:12<00:00,  3.61it/s, batch_loss=0.0643, avg_loss=0.1987]
Epoch 2/5: 100%|███████████████████| 1562/1562 [07:04<00:00,  3.68it/s, batch_loss=0.0108, avg_loss=0.1396]
Epoch 3/5: 100%|███████████████████| 1562/1562 [07:08<00:00,  3.65it/s, batch_loss=0.1896, avg_loss=0.1244]
Epoch 4/5: 100%|███████████████████| 1562/1562 [07:59<00:00,  3.26it/s, batch_loss=0.0091, avg_loss=0.1109]
Epoch 5/5: 100%|███████████████████| 1562/1562 [08:22<00:00,  3.11it/s, batch_loss=0.0649, avg_loss=0.1005]
"""
...
def main():
    ...
    model, preprocess = clip.load(cfg.model_name, device=cfg.device)
    
    # 2. 【关键】执行手术，变成 Bagua 结构
    model = perform_bagua_surgery(model)
    model = model.to(cfg.device) 

    # 3. 【关键】加载你刚刚训练的 Epoch 5 权重
    # 替换为你实际保存的路径
    checkpoint_path = "test_bagua_epoch_5.pt" 
    print(f"[Info] Loading Bagua Checkpoint from {checkpoint_path}...")
    
    state_dict = torch.load(checkpoint_path, map_location=cfg.device)
    
    # 处理可能的 key 不匹配 (比如多了 'module.' 前缀)
    new_state_dict = {}
    for k, v in state_dict.items():
        name = k.replace("module.", "") # 去掉 DDP 前缀
        new_state_dict[name] = v
        
    msg = model.load_state_dict(new_state_dict, strict=False)
    print(f"[Info] Load result: {msg}")
    
    # 确保设为 Eval 模式
    model.eval()
    model = model.float() # 确保精度
